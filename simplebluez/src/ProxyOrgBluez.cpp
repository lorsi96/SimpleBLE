...
std::shared_ptr<LEAdvertisingManager1> ProxyOrgBluez::leadvertisingmanager1() {
...
void ProxyOrgBluez::register_advertisement(std::shared_ptr<Advertisement> advertisement) {
    leadvertisingmanager1()->RegisterAdvertisement(advertisement->path());
}
